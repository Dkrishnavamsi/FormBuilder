      ...
      {savedForms.length === 0 ? (
        ...
        <>
          <Alert severity="info" sx={{ mb: 3 }}>
            All forms are saved locally in your browser's storage. Click
            &quot;Preview&quot; to test a form or &quot;Edit&quot; to modify it.
          </Alert>

          <Grid container spacing={3}>
            {[...savedForms] // create a shallow copy so sort() won't mutate Redux state
              .sort(
                (a, b) =>
